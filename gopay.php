...
ulang:
// function change(){
echo "\e[93m<=========BAKULER SEKURITAS SMG=========> \n";
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[32m         SCRIFT GOJEK 24 JULI MUNGKIN      \n";
echo "\e[93m  ===================================== \n";
echo "\e[93m   PASTIKAN SUDAH MENGGUNAKAN FAKE GPS     \n";
echo "\e[96m        [!]GUNAKAN UNTUK MAKAN JANGAN PACARAN[!]         \n";
echo "\e[93m  ======================================\n";
...
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
        ...
        if(strpos($code1, 'Promo kamu sudah bisa dipakai Sayang')){
	...
	$post = [
         ...
         echo color("white","[×] NUB GAGAL!!!\n");
         }
         }
         }
         }else{
         echo color("red","[-] NUB OTP SALAH!!");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
