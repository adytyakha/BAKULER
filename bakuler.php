...
echo "\n".color("red","Brazil Redy To LOSE?: y/n ");
        ...
        echo color("green","=======>SEBENERNYA AKU SAYANG, TAPI BOONG!!!!<========");
        ...
        if(strpos($code1, 'Mantap Udah Dikirim dari Bakuler nih')){
        ...
        echo "\n".color("green"," KAMU DAPET INI, BAKULER HEBAT KAN?  ".$total." : ");
